        ...
        >
          <Box p={{ base: "0", sm: "25px" }}>
            ...
            <Flex mt="15px" justify="start">
              ...
              <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <a target="_blank" href="jemacias:jesusmanuel.maciasmartinez@gmail.com">
                  <Text
                    fontSize="sm"
                    color="#00796B"
                    fontWeight="500"
                    ...
                    id="contact-email"
                  >
                    jesusmanuel.maciasmartinez@gmail.com
                  </Text>
                </a>
              </motion.div>
            </Flex>
            ...
            <Flex mt="25px">
              <Box w="10%">
                <a
                  target="_blank"
                  href="https://www.linkedin.com/in/jesusmacias-desarrollador-backend/"
                >
                  <motion.div
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
            ...
            <Flex mt="25px">
              <Box w="10%">
                <a target="_blank" href="https://github.com/Ragnar9902">
                  <motion.div
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
                    style={{ width: "10%" }}
